...
Ref<Curve> TG_PathParams::_b_getRadiusCurve() const
{
    return radius_curve;
}
godot::Ref<Curve> TG_PathParams::_b_getLengthCurveAlongParent() const
{
    return length_curve_along_parent;
}
