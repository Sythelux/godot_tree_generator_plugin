...
protected:
    ...
    /*	static void _register_methods() {
            ...
            godot::register_property("along_amount_per_unit",
       &TG_SpawnParams::along_amount_per_unit, 0.f); godot::register_property("along_begin_ratio",
       &TG_SpawnParams::along_begin_ratio, 0.f); godot::register_property("along_end_ratio",
       &TG_SpawnParams::along_end_ratio, 1.f); godot::register_property("along_jitter",
       &TG_SpawnParams::along_jitter, 0.f); godot::register_property("skip_probability",
       &TG_SpawnParams::skip_probability, 0.f);
       ...
       static_cast<float>(Math_PI) / 3.f); godot::register_property("vertical_angle_jitter",
       &TG_SpawnParams::vertical_angle_jitter, 0.f);
        }*/
};
